<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入内容查询" style="width: 200px; margin-right: 10px" v-model="content"></el-input>
      <el-input placeholder="请输入题目名称查询" style="width: 200px" v-model="questionName"></el-input>
